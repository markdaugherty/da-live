...
// The selection toolbar only offers editing actions (formatting, links, images),
// so it must stay hidden for read-only users. Fail-secure default: no write access.
